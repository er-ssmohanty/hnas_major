...
def main(train_dir="/home/shubhransu_etc/project_sys22/data/thermogram/train"):
    ...
    best_architecture = genetic_algorithm(train_dir=train_dir,len_classes=2,epochs=10, num_generations=20, mutation_rate=0.15,\
